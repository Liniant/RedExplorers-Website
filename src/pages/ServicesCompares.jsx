...
export default function ServicesCompare(){
    ...
    const[country1,setCountry1]= useState('Zimbabwe')
    const[country2,setCountry2]= useState('Mauritius')
 ...
 ///Variables for second country
    ...
    const fetchData = async (country1, country2) => {

                let  endpoint1 = `https://cost-of-living-and-prices.p.rapidapi.com/prices?country_name=${country1}`
                 let endpoint2 = `https://cost-of-living-and-prices.p.rapidapi.com/prices?country_name=${country2}`
        ...
        <>
            <div className="services-comp">
                ...
                <div className="compares">
                    <input type="text" className="f-inputs" placeholder="Search Country" value={country1} onChange={(e)=>{ setCountry1(e.target.value)}}/>
                    <div onClick={()=>{handleClick()}} style={{padding :"15px"}}><Button text='Compare' /></div>
                    <input type="text" className="f-inputs" placeholder="Search Country"  value={country2} onChange={(e)=>{ setCountry2(e.target.value)}}/>
                </div>
